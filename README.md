...
[⬇️ 下载已构建 JAR](https://github.com/zedoCN/ChatImage/releases/tag/v1.4.7-port.6%2B26.2) · [安装与使用说明](fabric/fabric-26.2/README.md) · [MCP 实机验证](fabric/fabric-26.2/tests/MCP-VALIDATION.md)
